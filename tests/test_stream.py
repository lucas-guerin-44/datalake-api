...
def seed_bars():
    ...
    with datalake.get_db_connection() as con:
        con.execute("""
            ...
            ('XAUUSD', 'M5', '2024-01-01 09:00:00', 2645.00, 2646.50, 2644.50, 2646.00, 'raw'),
            ('XAUUSD', 'M5', '2024-01-01 09:05:00', 2646.00, 2647.00, 2645.50, 2645.50, 'raw'),
            ('XAUUSD', 'M5', '2024-01-01 09:10:00', 2645.50, 2646.00, 2645.00, 2645.80, 'raw')
        """)
